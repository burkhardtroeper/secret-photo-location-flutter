      ...
      _locations.forEach((location) {
        var tempLocation = MonumentMarker(
            monument: Monument(
                ...
                lens: location.lens,
                aperture: location.aperture,
                exposureTime: location.exposureTime,
                iso: location.iso,
                lat: location.lat,
                long: location.long,
  ...
  void addLocation(Monument newLocation) {
    ...
    var tempMarker = MonumentMarker(
        monument: Monument(
            ...
            camera: newLocation.camera,
            lens: newLocation.lens,
            aperture: newLocation.aperture,
            exposureTime: newLocation.exposureTime,
            iso: newLocation.iso,
            lat: newLocation.lat,
